...
try {
    $orderStmt = $pdo->prepare('SELECT id, order_number, user_id, status, subtotal, shipping_amount, discount_amount, total_amount, customer_notes, artist_notes, shipping_name, shipping_phone, shipping_address_line_1, shipping_address_line_2, shipping_city, shipping_state, shipping_postal_code, shipping_country, tracking_courier, tracking_id, tracking_url, accepted_at, paid_at, dispatched_at, delivered_at, created_at, updated_at FROM orders WHERE id = ? LIMIT 1');
