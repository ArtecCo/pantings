...
try {
    $orderStmt = $pdo->prepare('SELECT o.id, o.order_number, o.user_id, o.status, o.subtotal, o.base_amount, o.customization_amount, o.shipping_amount, o.delivery_amount, o.discount_amount, o.total_amount, o.payment_link, o.price_released_at, o.price_released_by, o.customer_notes, o.artist_notes, o.shipping_name, o.shipping_phone, COALESCE(o.customer_email, u.email) AS customer_email, o.shipping_address AS shipping_address_line_1, NULL AS shipping_address_line_2, o.shipping_city, o.shipping_state, o.shipping_postal_code, o.shipping_country, o.tracking_courier, o.tracking_id, o.tracking_url, o.accepted_at, o.paid_at, o.dispatched_at, o.delivered_at, o.created_at, o.updated_at FROM orders o LEFT JOIN users u ON u.id = o.user_id WHERE o.id = ? LIMIT 1');
